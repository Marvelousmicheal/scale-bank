...
function Stat({ label, value }: { label: string; value: string }) {
  return (
    <article className="flex min-h-[77px] flex-col justify-center rounded-[20px] border border-light-gray/10 bg-surface-deep px-[15px] font-sf-pro">
  ...
  return (
    <div className="flex min-h-full flex-col gap-[15px] px-[30px] pb-[30px] pt-[46px]">
      ...
      <section className="grid grid-cols-[1fr_282px] gap-[15px] rounded-[12px] border border-light-gray/10 bg-app-black p-[15px]">
        <div>
          <div className="flex min-h-[84px] items-center justify-between rounded-[12px] border border-light-gray/10 bg-surface-raised px-[15px]">
            <div className="font-sf-pro">
              ...
              <div className="mt-1 flex gap-4 text-sm text-ink-muted"><span>Reeva Supermarket</span><span>Feb 10 2026</span></div>
            </div>
            <div className="flex gap-2.5">
              <button className="h-11 rounded-[12px] bg-action-blue px-[15px] font-sf-pro text-base font-bold">Retry Settlement</button>
              <button disabled className="flex h-11 items-center gap-3 rounded-[12px] bg-surface-overlay px-[15px] font-sf-pro text-base font-bold text-ink-muted">Download Report <Download className="size-5" /></button>
            </div>
          </div>
        ...
        <aside className="rounded-[20px] bg-surface-base p-[15px] font-sf-pro">
          ...
          <div className="rounded-[12px] bg-surface-muted px-3 py-2"><p className="text-sm font-bold text-ink-soft">Access Bank</p><p className="text-sm text-ink-muted">•••• 9021</p></div>
          <div className="mt-4"><p className="text-sm font-bold text-ink-soft">Account Name</p><p className="text-xs text-ink-muted">Reeva Supermarket Ltd</p></div>
        </aside>
      </section>
      ...
      <section className="grid grid-cols-[1fr_280px] gap-[15px] rounded-[12px] border border-light-gray/10 bg-app-black p-[15px]">
        ...
        <aside className="rounded-[16px] bg-surface-base p-[15px]">
          ...
          <div className="space-y-2.5">
            ...
            <button className="flex h-11 w-full items-center justify-center gap-3 rounded-[12px] bg-action-red font-sf-pro font-bold">Reverse Transaction <RotateCcw className="size-5" /></button>
          </div>
        </aside>
      </section>
      ...
      <section className="grid grid-cols-[1fr_0.7fr] gap-[15px]">
        <article className="rounded-[12px] bg-app-black p-[15px] font-sf-pro">
          ...
          <div className="flex h-11 items-center justify-between rounded-[12px] bg-surface-elevated px-3 text-sm font-bold text-ink-muted"><span>Time Stamp</span><span className="text-ink-bright">Status</span></div>
          <div className="space-y-7 pt-6 text-sm text-ink-muted">
        ...
        <article className="rounded-[12px] bg-app-black p-[15px] font-sf-pro">
          ...
          <div className="mt-4 flex justify-between px-3 text-sm font-bold text-ink-muted"><span>Description</span><span>Amount</span></div>
          <div className="mt-5 space-y-2.5 text-sm font-bold">
            <div className="flex h-11 items-center justify-between rounded-[12px] bg-surface-elevated px-[15px] text-ink-muted"><span>Gross Transaction Volume</span><span className="text-ink-bright">₦1,240,500</span></div>
            <div className="flex h-11 items-center justify-between rounded-[12px] bg-surface-elevated px-[15px] text-ink-muted"><span>Total Platform Fee</span><span className="text-ink-bright">₦12,500</span></div>
            <div className="flex h-11 items-center justify-between rounded-[12px] bg-action-blue-deep px-[15px]"><span>Net Settlement Amount</span><span>₦1,228,000</span></div>
          </div>
        </article>
      </section>
    </div>
